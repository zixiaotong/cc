...
public class readNginxConf {
    ...
    public void test3() throws IOException {
        ...
        for (int i = 0; i < arrayList1.size(); i++) {
            if ("upstream chaoshi.zhangheyun.cn {".equals(arrayList1.get(i).toString())) {
    ...
    //    int port = 22;// 端口号
    //    String cmd = "cat /usr/local/nginx/conf/nginx.conf";// 要运行的命令
    ...
    //            }
    //        }
    //        if (arrayList1.get(i).toString().startsWith("include") && arrayList1.get(i).toString().contains("conf")) {
    //            String path = arrayList1.get(i).toString().split(" ")[1];
